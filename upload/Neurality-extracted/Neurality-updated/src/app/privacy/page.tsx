      ...
      <main>
        <div className="legal-page">
          ...
          */}
          ...
          <p>
            Neurality-Inc ("Neurality," "we," "us," or "our") is committed to
            protecting your privacy. This Privacy Policy explains how we
            collect, use, share, and safeguard information when you use our
            products, services, websites, bots, and applications (collectively,
          ...
          <ul>
            ...
            <li>
              <strong>Discord data:</strong> When you add one of our Discord
              bots (Axion, birat.gg) to a server, we may receive your Discord
              user ID, server ID, and messages sent in channels where the bot
              is active, solely to provide the requested functionality.
            </li>
            <li>
            ...
            <li>
              <strong>Device and technical data:</strong> We may collect your
          ...
          <ul>
            ...
            <li>
              Monitor usage patterns to understand how our Services are used
              and to inform product decisions.
            </li>
            <li>
          ...
          <p>
            ...
            analytics software) to collect aggregated, anonymised data about
            how users navigate our Services. These tools do not receive
          ...
          <ul>
            <li>
              ...
              services) who assist us in operating our Services. These vendors
              are contractually required to keep your information confidential
              and to use it only to perform services on our behalf.
            </li>
            <li>
          ...
          <p>
            ...
            <a
              href="mailto:privacy@neurality.dev"
              style={{ color: "var(--accent)" }}
            >
              privacy@neurality.dev
            </a>
          ...
          <p>
            ...
            (or a higher minimum age where required by local law). We do not
          ...
          <p>
            ...
            will revise the "Effective date" at the top of this page and, where
            appropriate, notify you by email or through a notice in our Services.
            We encourage you to review this policy periodically. Your continued
            use of the Services after changes become effective constitutes your
